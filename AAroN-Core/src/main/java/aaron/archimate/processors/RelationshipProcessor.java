...
public class RelationshipProcessor extends AbstractProcessor<RelationshipType> {
    ...
    public void process(RelationshipType relationshipType) {
        ...
        Identifier<String> start = new ArchiMateNodeIdentifier(source.getIdentifier());
        Identifier<String> end = new ArchiMateNodeIdentifier(target.getIdentifier());
        ...
        UniqueEdgeIdentifier<UUID> uniqueIdentifier = new UniqueEdgeIdentifierImpl();
        model.addEdge(uniqueIdentifier, edge);
        model.addEdgeIdentifier(new ArchiMateEdgeIdentifier(identifier), uniqueIdentifier);
    }
}
